...
import { weaponWildSurges } from '../assets/weaponWildSurges';
...
type SurgeType = typeof SURGE_TYPES[keyof typeof SURGE_TYPES];

const RandomTables: React.FC = () => {
  const [selectedType, setSelectedType] = useState<SurgeType>(SURGE_TYPES.WEAPON);
  ...
  return (
    <PageLayout title="Random Tables">
      <div className="wild-surge-info">
        <select 
          value={selectedType}
          onChange={(e) => setSelectedType(e.target.value as SurgeType)}
